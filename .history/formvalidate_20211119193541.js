...
$(function () {
    ...
    $('input[value="Submit"]').on("click", function () {
        ...
        $("#FormInput").validate({
            ...
            messages: {
                ...
                clearinput: {
                    range: "The range of Delete Specified Tab must stay within 2, and the number of tables produced, and it should only contain numerical digits"
                }
            },
    ...
    $('input[name="clearx"]').on("click", function() {
        if ($('input[name="clearinput"]').val() > 1) {
