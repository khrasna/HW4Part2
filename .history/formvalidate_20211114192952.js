$(function () {
    ...
    $("#slider-1").slider({
        ...
        slide: function (event, ui) {
            ...
            console.log($('input[name="MultiplierStart"]').value);
        }
    });
    $("#slider-2").slider({
        min: -50,
        ...
        slide: function (event, ui) {
            ...
            console.log(ui.value);
            console.log($('input[name="MultiplierFinish"]').value);
        }
    });
    $("#slider-3").slider({
        min: -50,
        ...
        slide: function (event, ui) {
            ...
            console.log(ui.value);
            console.log($('input[name="MultiplicandStart"]').value);
        }
    });
    $("#slider-4").slider({
        min: -50,
        ...
        slide: function (event, ui) {
            ...
            console.log(ui.value);
            console.log($('input[name="MultiplicandFinish"]').value);
        }
    });
