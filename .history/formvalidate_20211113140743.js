...
function process() {
    debugger;
    var multStart = $('input[name="Multiplier Start"]').value;
    var multFinish = $('input[name="Multiplier Finish"]').value;
    var multiplicandStart = $('input[name="Multiplicand Start"]').value;
    var multiplicandFinish = $('input[name="Multiplicand Finish"]').value;
