...
$(function () {
        ...
        $("#FormInput").validate({
            ...
            messages: {
                MultiplierStart: {
                    ...
                    digit: "Multiplier Start must consist of only integers",
                ...
                MultiplierFinish: {
                    ...
                    digit: "Multiplier finish must consist of only integers",
                ...
                MultiplicandStart: {
                    ...
                    digit: "Multiplicand Start must consist of only integers",
                ...
                MultiplicandFinish: {
                    ...
                    digit: "Multiplicand Finish must consist of only integers",
    ...
    $('input[name="clearx"]').on("click", function () {
        $("#FormInput").validate({
            onkeyup: false,     //this makes it so the validator doesnt update the error messages whenever new input is typed. only validates when submit is hit.
            onfocusout: false,  //learned about onkeyup, and onfocusout at https://www.sitepoint.com/jquery-validation-validate-form-submit/
            rules: {
