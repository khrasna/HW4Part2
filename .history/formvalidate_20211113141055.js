$(function () {
    ...
    $.validator.addMethod("less", function (value, element, params) {
        return this.optional(element) || value <= params[0].vlue; //checks to make sure that the starts are less than the finishes, learned from
...
function process() {
    ...
    var multFinish = $('input[name="MultiplierFinish"]').value;
    var multiplicandStart = $('input[name="MultiplicandStart"]').value;
    var multiplicandFinish = $('input[name="MultiplicandFinish"]').value;
