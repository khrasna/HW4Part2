jQuery(function() {
    ...
    $.validator.addMethod("less1", function (value, element) {
        return MultiplierStart <= MultiplierFinish;
    }, "* The value of Multiplier Start must be less than or equal to Multiplier Finish.");

    $.validator.addMethod("less2", function (value, element) {
        return MultiplicandStart <= MultiplicandFinish;
    }, "* The value of Multiplicand Start must be less than or equal to Multiplicand Finish.");
